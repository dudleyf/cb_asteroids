            ...
            Interaction::Pressed => {
                ...
                *color = PRESSED_BUTTON.into();
                match text.sections[0].value.as_str() {
                    "New Game" => {
                        next_state.set(GameState::ChooseShip);
                    }
                    "Settings" => {
                    ...
                    _ => {
                        unimplemented!("Button goes nowhere");
                    }
                }
            }
            Interaction::Hovered => {
...
impl<T: Into<String> + Send + 'static> Command for SpawnButton<T> {
    fn apply(self, world: &mut World) {
        ...
        let space_sheet = {
            ...
            spritesheets
                ...
                .expect("space sheet to have been loaded")
        };
